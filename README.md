...
prerequisite: docker, docker-compose, composer, npm, your user is in the docker group. If not see [below](install docker-io and docker-compose)

1. clone this git and open it `git clone git clone git@gitlab.metaways.net:tine20/docker.git tine20-docker` and cd tine20-docker`
